...
Usage:
    python process_local_batch.py <folder_path>

Example:
    python process_local_batch.py "C:/Users/YourName/Documents/ExcelFiles"
"""
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python process_local_batch.py <folder_path>")
        print("\nExample:")
        print('  python process_local_batch.py "C:/Users/YourName/Documents/ExcelFiles"')
        print('  python process_local_batch.py "./DATA/raw_files"')
        sys.exit(1)
